...
export default function Home() {
  ...
  const allPlaces = [
    ...
    { id: "jaipur_flight", type: "flights", state: "Rajasthan", code: "JAI", titleKey: "places_jaipur_title", descKey: "places_jaipur_desc", detailsKey: "places_jaipur_details", highlightsKey: "places_jaipur_highlights", bestTimeKey: "places_jaipur_best_time", img: "/places/taj_mahal.png", imgs: ["/places/taj_mahal.png"], price: "₹2,799" },
    { id: "bengaluru_flight", type: "flights", state: "Karnataka", code: "BLR", titleKey: "places_bengaluru_title", descKey: "places_bengaluru_desc", detailsKey: "places_bengaluru_details", highlightsKey: "places_bengaluru_highlights", bestTimeKey: "places_bengaluru_best_time", img: "/places/coorg_plantation.png", imgs: ["/places/coorg_plantation.png"], price: "₹3,999" },
    { id: "mumbai_flight", type: "flights", state: "Maharashtra", code: "BOM", titleKey: "places_mumbai_title", descKey: "places_mumbai_desc", detailsKey: "places_mumbai_details", highlightsKey: "places_mumbai_highlights", bestTimeKey: "places_mumbai_best_time", img: "/places/ajanta_caves.png", imgs: ["/places/ajanta_caves.png"], price: "₹4,599" },
    { id: "varanasi_flight", type: "flights", state: "Uttar Pradesh", code: "VNS", titleKey: "places_varanasi_title", descKey: "places_varanasi_desc", detailsKey: "places_varanasi_details", highlightsKey: "places_varanasi_highlights", bestTimeKey: "places_varanasi_best_time", img: "/places/taj_mahal.png", imgs: ["/places/taj_mahal.png"], price: "₹3,299" },
    { id: "munnar_flight", type: "flights", state: "Kerala", code: "COK", titleKey: "places_munnar_title", descKey: "places_munnar_desc", detailsKey: "places_munnar_details", highlightsKey: "places_munnar_highlights", bestTimeKey: "places_munnar_best_time", img: "/places/kerala_houseboat.png", imgs: ["/places/kerala_houseboat.png"], price: "₹5,199" },
    { id: "pondicherry_flight", type: "flights", state: "Tamil Nadu", code: "MAA", titleKey: "places_pondicherry_title", descKey: "places_pondicherry_desc", detailsKey: "places_pondicherry_details", highlightsKey: "places_pondicherry_highlights", bestTimeKey: "places_pondicherry_best_time", img: "/places/goa_beach.png", imgs: ["/places/goa_beach.png"], price: "₹2,199" },
    ...
    { id: "goa_hotel", type: "hotels", state: "Goa", titleKey: "places_goa_hotel_title", descKey: "places_goa_hotel_desc", detailsKey: "places_goa_hotel_details", highlightsKey: "places_goa_hotel_highlights", bestTimeKey: "places_goa_hotel_best_time", img: "/places/goa_sunset.png", imgs: ["/places/goa_sunset.png"], rating: "4.7 ★" },
    ...
    { id: "mumbai_hotel", type: "hotels", state: "Maharashtra", titleKey: "places_mumbai_hotel_title", descKey: "places_mumbai_hotel_desc", detailsKey: "places_mumbai_hotel_details", highlightsKey: "places_mumbai_hotel_highlights", bestTimeKey: "places_mumbai_hotel_best_time", img: "/places/ajanta_caves.png", imgs: ["/places/ajanta_caves.png"], rating: "4.9 ★" },
    ...
    { id: "wayanad_kerala_home", type: "homestays", state: "Kerala", titleKey: "places_wayanad_title", descKey: "places_wayanad_desc", detailsKey: "places_wayanad_details", highlightsKey: "places_wayanad_highlights", bestTimeKey: "places_wayanad_best_time", img: "/places/kerala_houseboat.png", imgs: ["/places/kerala_houseboat.png"], rating: "4.8 ★" },
    { id: "lonavala_home", type: "homestays", state: "Maharashtra", titleKey: "places_lonavala_title", descKey: "places_lonavala_desc", detailsKey: "places_lonavala_details", highlightsKey: "places_lonavala_highlights", bestTimeKey: "places_lonavala_best_time", img: "/places/ajanta_caves.png", imgs: ["/places/ajanta_caves.png"], rating: "4.4 ★" },
    ...
    { id: "jaipur_bus", type: "buses", state: "Rajasthan", titleKey: "places_jaipur_bus_title", descKey: "places_jaipur_bus_desc", detailsKey: "places_jaipur_bus_details", highlightsKey: "places_jaipur_bus_highlights", bestTimeKey: "places_jaipur_bus_best_time", img: "/places/taj_mahal.png", imgs: ["/places/taj_mahal.png"], price: "₹1,099" },
    { id: "pondicherry_bus", type: "buses", state: "Tamil Nadu", titleKey: "places_pondicherry_bus_title", descKey: "places_pondicherry_bus_desc", detailsKey: "places_pondicherry_bus_details", highlightsKey: "places_pondicherry_bus_highlights", bestTimeKey: "places_pondicherry_bus_best_time", img: "/places/goa_beach.png", imgs: ["/places/goa_beach.png"], price: "₹499" },
    { id: "mysore_bus", type: "buses", state: "Karnataka", titleKey: "places_mysore_bus_title", descKey: "places_mysore_bus_desc", detailsKey: "places_mysore_bus_details", highlightsKey: "places_mysore_bus_highlights", bestTimeKey: "places_mysore_bus_best_time", img: "/places/coorg_plantation.png", imgs: ["/places/coorg_plantation.png"], price: "₹799" },
    ...
    { id: "rameshwaram_cruise", type: "cruise", state: "Tamil Nadu", titleKey: "places_rameshwaram_cruise_title", descKey: "places_rameshwaram_cruise_desc", detailsKey: "places_rameshwaram_cruise_details", highlightsKey: "places_rameshwaram_cruise_highlights", bestTimeKey: "places_rameshwaram_cruise_best_time", img: "/places/lakshadweep_beach.png", imgs: ["/places/lakshadweep_beach.png"], price: "₹6,200" },
    ...
    { id: "jaipur_tour", type: "tours", state: "Rajasthan", titleKey: "places_jaipur_tour_title", descKey: "places_jaipur_tour_desc", detailsKey: "places_jaipur_tour_details", highlightsKey: "places_jaipur_tour_highlights", bestTimeKey: "places_jaipur_tour_best_time", img: "/places/taj_mahal.png", imgs: ["/places/taj_mahal.png"], durationKey: "places_jaipur_tour_duration" },
    { id: "delhi_tour", type: "tours", state: "Delhi", titleKey: "places_delhi_tour_title", descKey: "places_delhi_tour_desc", detailsKey: "places_delhi_tour_details", highlightsKey: "places_delhi_tour_highlights", bestTimeKey: "places_delhi_tour_best_time", img: "/places/delhi_imperial.png", imgs: ["/places/delhi_imperial.png"], durationKey: "places_delhi_tour_duration" },
    { id: "mysore_tour", type: "tours", state: "Karnataka", titleKey: "places_mysore_tour_title", descKey: "places_mysore_tour_desc", detailsKey: "places_mysore_tour_details", highlightsKey: "places_mysore_tour_highlights", bestTimeKey: "places_mysore_tour_best_time", img: "/places/coorg_plantation.png", imgs: ["/places/coorg_plantation.png"], durationKey: "places_mysore_tour_duration" },
    { id: "kashi_tour", type: "tours", state: "Uttar Pradesh", titleKey: "places_kashi_title", descKey: "places_kashi_desc", detailsKey: "places_kashi_details", highlightsKey: "places_kashi_highlights", bestTimeKey: "places_kashi_best_time", img: "/places/taj_mahal.png", imgs: ["/places/taj_mahal.png"], durationKey: "places_kashi_duration" }
  ];
